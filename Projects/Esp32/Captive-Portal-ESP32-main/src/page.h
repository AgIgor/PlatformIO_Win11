static const char adminPage[] PROGMEM = {
    R"(
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
...
static const char configPage[] PROGMEM = {
    ...
    <body>
        <div class="container">
            <h1>Conexão Wi-Fi</h1>
            <form id="wifi-form" method="post" action="/salvar">
                <label for="ssid">Nome da Rede Wi-Fi:</label>
                <input type="text" id="ssid" name="ssid" placeholder="Digite o SSID"> 
