...
//Variables
float set_temperature = 140;            //Default temperature setpoint. Leave it 0 and control it with rotary encoder
...
void loop() {
  ...
  set_temperature = map(analogRead(speed_pot),0,1024,0,260);
